...
if __name__ == '__main__':
    ...
    test_path = 'annotation/voc2012_test.txt'   # 如果没有测试集，填None；如果有测试集，填txt注解文件的路径。
    classes_path = 'data/voc_classes.txt'
    train_pre_path = 'JPEGImages/'   # 训练集图片相对路径
    val_pre_path = 'JPEGImages/'     # 验证集图片相对路径
    test_pre_path = 'JPEGImages/'    # 测试集图片相对路径
